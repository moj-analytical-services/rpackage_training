...
You should not hold any sensitive data in Github.com. To prevent you accidentally pushing any sensitive data to Github.com: 

* It is best practice not to store any sensitive data within the R Studio copy of your repository. 
